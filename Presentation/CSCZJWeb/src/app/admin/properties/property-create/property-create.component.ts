...
import { PropertyCreateModel, SameIdPropertyModel, PropertyPictureModel, PropertyFileModel } from 'src/app/viewModels/properties/property';
import { FormGroup, FormsModule, ReactiveFormsModule, FormBuilder, Validators, FormControl, ValidationErrors } from '@angular/forms';
...
export class PropertyCreateComponent implements OnInit {
  ...
  current: number;
  stepStatus: string;
  property = new PropertyCreateModel();
  orginalPropertyName: string;
  isSameCardIdLoading: boolean;
  sameCardIdChecked: boolean;
  sameCardProperties: SameIdPropertyModel[];
