...
export class Property extends PropertyListItem {
    ...
    patrols: PropertyPatrolModel;
    propertyOff: PropertyOffModel;
...
export class PropertyPatrolModel extends ApproveModel {
    id: number;
    ids?: string;
    patrolDate: string;
    people: string;
    ...
    tel: string;
    title: string;
    patrolPictures: PropertyPictureModel[];
    constructor() {
        super();
        this.ids = "";
        this.patrolDate = "";
