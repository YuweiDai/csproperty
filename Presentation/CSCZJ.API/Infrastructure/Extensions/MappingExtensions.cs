...
namespace CSCZJ.Web.Api.Extensions
{
    /// <summary>
    /// 实体到模型映射
    /// </summary>
    public static class MappingExtensions
    {
        ...
        #region 资产巡查
        public static PropertyPatrolModel ToModel(this PropertyPatrol entity)
        {
            return entity.MapTo<PropertyPatrol, PropertyPatrolModel>();
        }

        public static PropertyPatrolModel ToListModel(this PropertyPatrol entity)
        {
            return entity.MapTo<PropertyPatrol, PropertyPatrolModel>();
        }
