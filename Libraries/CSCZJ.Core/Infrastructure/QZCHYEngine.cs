...
namespace CSCZJ.Core.Infrastructure
{
    ...
    public class CSCZJEngine : IEngine
    {
        ...
        protected virtual void RegisterDependencies(CSCZJConfig config, HttpConfiguration httpConfig)
        {
            ...
            builder.RegisterInstance(config).As<CSCZJConfig>().SingleInstance();
        ...
        /// </summary>
        /// <param name="config">Config</param>
        public void Initialize(CSCZJConfig config,HttpConfiguration httpConfig)
        {
