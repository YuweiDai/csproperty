...
namespace CSCZJ.Services.Property
{
    ...
    {
        IPagedList<CSCZJ.Core.Domain.Properties.PropertyAllot> GetAllAllotRecords(IList<int> governmentIds, string checkState = "unchecked", string search = "", int pageIndex = 0,
