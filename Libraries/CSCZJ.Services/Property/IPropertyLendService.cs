...
namespace CSCZJ.Services.Property
{
   public interface IPropertyLendService
    {
        IPagedList<CSCZJ.Core.Domain.Properties.PropertyLend> GetAllLendRecords(IList<int> governmentIds, string checkState = "unchecked", string search = "", int pageIndex = 0,
