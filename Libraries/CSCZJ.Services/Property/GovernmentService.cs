...
namespace CSCZJ.Services.Property
{
    public class GovernmentService:IGovernmentService
    {
        ...
        /// {0} : category ID
        /// </remarks>
        private const string GOVERNMENTUNITS_BY_ID_KEY = "CSCZJ.government.id-{0}";
        /// <summary>
        /// Key for caching
        /// </summary>
        /// <remarks>
        ...
        /// </remarks>
        private const string GOVERNMENTUNITS_BY_PARENT_GOVERNMENTUNIT_ID_KEY_INCLUDECHILDREN = "CSCZJ.government.byparent-{0}-{1}-{2}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string GOVERNMENTUNITS_PATTERN_KEY = "CSCZJ.government.";
