   ...
   public class PropertyNewCreateService: IPropertyNewCreateService
    {
        ...
        public virtual IPagedList<CSCZJ.Core.Domain.Properties.PropertyNewCreate> GetAllNewCreateRecords(IList<int> governmentIds, string checkState = "", string search = "", int pageIndex = 0, int pageSize = int.MaxValue, params PropertySortCondition[] sortConditions)
        {
            ...
            Expression<Func<CSCZJ.Core.Domain.Properties.PropertyNewCreate, bool>> expression = p => !p.Deleted;
            ...
            var propertiesNewCreateRecords = new PagedList<CSCZJ.Core.Domain.Properties.PropertyNewCreate>(query, pageIndex, pageSize);
