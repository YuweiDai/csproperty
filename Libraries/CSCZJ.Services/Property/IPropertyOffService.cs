...
namespace CSCZJ.Services.Property
{
    ...
    {
        IPagedList<CSCZJ.Core.Domain.Properties.PropertyOff> GetAllOffRecords(IList<int> governmentIds, string checkState = "unchecked", string search = "", int pageIndex = 0,
