...
namespace CSCZJ.Services.Logging
{
    /// <summary>
    ...
    public class AccountUserActivityService : IAccountUserActivityService
    {
        ...
        /// Key for caching
        /// </summary>
        private const string ACTIVITYTYPE_ALL_KEY = "CSCZJ.activitytype.all";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string ACTIVITYTYPE_PATTERN_KEY = "CSCZJ.activitytype.";
