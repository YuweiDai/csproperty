...
namespace CSCZJ.Services.Helpers
{
    /// <summary>
    /// User agent helper
    /// </summary>
    ...
    {
        private readonly CSCZJConfig _config;
        ...
        public UserAgentHelper(CSCZJConfig config, IWebHelper webHelper, HttpContextBase httpContext)
        {
            this._config = config;
