...
namespace CSCZJ.Services.Media
{
    ...
    public partial class PictureService : IPictureService
    {
        ...
        protected virtual string GetThumbLocalPath(string thumbFileName)
        {
            ...
            if (!Directory.Exists(thumbsDirectoryPath)) Directory.CreateDirectory(thumbsDirectoryPath);
            ...
            string storeLocation = null)
        {
            ...
            switch (defaultPictureType)
            {
                case PictureType.Avatar:
                    defaultImageFileName = _settingService.GetSettingByKey("Media.AccountUser.DefaultAvatarImageName", "default-avatar.jpg");
                    break;
        ...
        public virtual bool ExsitById(int pictureId)
        {
            return _pictureRepository.Table.Where(p => p.Id == pictureId).Count() > 0;
        }
        ...
        /// 根据base64保存图片
        /// </summary>
        /// <param name="base64">前台提交的js版本的base64</param>
        ...
        /// <returns></returns>
        public virtual Picture InsertPicture(string base64, string seoFilename = "", string altAttribute = null, string titleAttribute = null,
            bool isNew = true, bool validateBinary = true)
        {
            string mimeType = "";
            try
            ...
            //获取.net 识别的base64
            base64 = base64.Split(';')[1].Replace("base64,", "").Trim(); 
            //转换成二进制
        ...
        /// <param name="titleAttribute"></param>
        /// <returns></returns>
        public virtual Picture UpdatePicture(int pictureId, string seoFilename, string altAttribute = null, string titleAttribute = null)
        {       
        ...
        /// <summary>
        /// Validates input picture dimensions 验证图片尺寸，如果不符合则完成裁切
        /// </summary>
        /// <param name="pictureBinary">Picture binary</param>
        /// <param name="mimeType">MIME type</param>
